...
//  **** INICIO EVENTOS ****
    ...
    //botao tabela 2025
    var btn_2025 = document.getElementById("btn-tab-2025");
    btn_2025.addEventListener("click", cliqueTab2025);


    //botao tabela 2026
    var btn_2026 = document.getElementById("btn-tab-2026");
    btn_2026.addEventListener("click", cliqueTab2026);
...
// alterar texto btn tabela 2025
function cliqueTab2025() {    
    if (document.getElementById("btn-tab-2025").innerHTML == "Ver tabela INSS 2025") {
        document.getElementById("btn-tab-2025").innerHTML = "Ocultar tabela INSS 2025";
    } else if (document.getElementById("btn-tab-2025").innerHTML == "Ocultar tabela INSS 2025") {
        document.getElementById("btn-tab-2025").innerHTML = "Ver tabela INSS 2025";
    }
}


// alterar texto btn tabela 2026
function cliqueTab2026() {    
    if (document.getElementById("btn-tab-2026").innerHTML == "Ver tabela INSS 2026") {
        document.getElementById("btn-tab-2026").innerHTML = "Ocultar tabela INSS 2026";
    } else if (document.getElementById("btn-tab-2026").innerHTML == "Ocultar tabela INSS 2026") {
        document.getElementById("btn-tab-2026").innerHTML = "Ver tabela INSS 2026";
    }
}
...
function AlterarAno() {
    ...
    if (document.getElementById("tabela").value == 2022) {
        ...
        // se tiver exibindo tabela, clica no botao para ocultar 
        if (document.getElementById("btn-tab-2025").innerHTML == "Ocultar tabela INSS 2025") {
            document.getElementById("btn-tab-2025").click();
        }
        // se tiver exibindo tabela, clica no botao para ocultar 
        if (document.getElementById("btn-tab-2026").innerHTML == "Ocultar tabela INSS 2026") {
            document.getElementById("btn-tab-2026").click();
        }
        ...
        document.getElementById("btn-tab-2025").style.display = "none";   // ocultar botao tabela 2025               
        document.getElementById("btn-tab-2026").style.display = "none";   // ocultar botao tabela 2026              
    ...
    if (document.getElementById("tabela").value == 2025) {
        ...
        document.getElementById("btn-tab-2025").style.display = "inline"; //exibir botao tabela 2025
        document.getElementById("btn-tab-2022").style.display = "none"; //oculta botao tabela 2022
        document.getElementById("btn-tab-2023").style.display = "none";   // ocultar botao tabela 2023               
        document.getElementById("btn-tab-2026").style.display = "none";   // ocultar botao tabela 2026          
    ...
    if (document.getElementById("tabela").value == 2026) {
        ...
        document.getElementById("btn-tab-2026").style.display = "inline"; //exibir botao tabela 2026
        document.getElementById("btn-tab-2022").style.display = "none"; //ocultar botao tabela 2022
        document.getElementById("btn-tab-2023").style.display = "none";   // ocultar botao tabela 2023               
        document.getElementById("btn-tab-2025").style.display = "none";   // ocultar botao tabela 2025         
...
function calcular() {
    ...
    } else if (anoInss == '2025') {

        // tabela INSS
        var ini_faixa1 = 0.01;
        var fim_faixa1 = 1518.00;

        var ini_faixa2 = 1518.01;
        var fim_faixa2 = 2793.88;

        var ini_faixa3 = 2793.89;
        var fim_faixa3 = 4190.84;

        var ini_faixa4 = 4190.85;
        var fim_faixa4 = 8157.41;
    ...
    }  else if (anoInss == '2026') {

        // tabela INSS
        var ini_faixa1 = 0.01;
        var fim_faixa1 = 1621.00;

        var ini_faixa2 = 1621.01;
        var fim_faixa2 = 2902.84;

        var ini_faixa3 = 2902.85;
        var fim_faixa3 = 4354.27;

        var ini_faixa4 = 4354.28;
        var fim_faixa4 = 8475.55;
