...
function AlterarAno() {
    ...
    if (document.getElementById("tabela").value == 2025) {
        ...
        document.getElementById("btn-tab-2025").style.display = "inline"; //exibir botao tabela 2022
        document.getElementById("btn-tab-2022").style.display = "none"; //exibir botao tabela 2022
        document.getElementById("btn-tab-2023").style.display = "none";   // ocultar botao tabela 2023               
